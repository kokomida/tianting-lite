...
class MemoryHubDAO:
    ...
    def _init_database(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            conn.execute("CREATE INDEX IF NOT EXISTS idx_windows_task_id ON windows(task_id)")
            conn.execute("CREATE INDEX IF NOT EXISTS idx_review_logs_task_id ON review_logs(task_id)")
    ...
    def search_memories(self, query: str, layer: str = "core", limit: int = 10) -> List[Dict[str, Any]]:
        """
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor = conn.execute("SELECT layer, COUNT(*) FROM tasks GROUP BY layer")
