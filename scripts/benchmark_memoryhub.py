...
def benchmark_memory_operations(memory_count: int = 10000, recall_queries: int = 1000):
    ...
    try:
        ...
        print(f"[DATA] Test data: {memory_count:,} memories, {recall_queries:,} recalls")
...
def main():
    ...
    if args.quick:
        memory_count = 1000
        recall_count = 100
        print("[QUICK] Running QUICK benchmark...")
    else:
